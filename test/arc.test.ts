...
describe('Arc', () => {
  test('from_svg_arc', () => {
    ...
    test_endpoints(new SvgArc(point(0, -10), point(10, 0), vector(10, 10), Angle.radians(0), flags))

    test_endpoints(
      new SvgArc(point(0, -10), point(10, 0), vector(100, 10), Angle.radians(0), flags)
    )

    test_endpoints(new SvgArc(point(0, -10), point(10, 0), vector(10, 30), Angle.radians(1), flags))

    test_endpoints(new SvgArc(point(5, -10), point(5, 5), vector(10, 30), Angle.radians(-2), flags))
  })
