...
export interface MonotonicSegment {
  solve_t_for_x(x: Scalar, t_range?: Range, tolerance?: Scalar): Scalar
}
...
export class MonotonicQuadraticBezierSegment<U = any> extends Segment<U>
  ...
  public solve_t_for_x(x: Scalar, _t_range?: Range, _tolerance?: Scalar): Scalar {
  ...
  public first_intersection_t(
    ...
    return first_monotonic_segment_intersection(this, self_t_range, other, other_t_range, tolerance)
  }
...
export class MonotonicCubicBezierSegment<U = any> extends Segment<U>
  ...
  public solve_t_for_x(x: Scalar, t_range: Range, tolerance: Scalar): Scalar {
...
>(a: A, a_t_range: Range, b: B, b_t_range: Range, tolerance: Scalar): Option<[Scalar, Scalar]> {
