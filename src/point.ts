...
export class Point2D<U = any> extends ImplOrd(ImplPartialOrd(ImplEq(ImplPartialEq(Self))))
  ...
  public min_assign(other: this["Self"]): this["Self"] {
    this.x = minnum(this.x, other.x);
    this.y = minnum(this.y, other.y);
    return this;
  }
  ...
  public max_assign(other: this["Self"]): this["Self"] {
    this.x = maxnum(this.x, other.x);
    this.y = maxnum(this.y, other.y);
    return this;
  }
