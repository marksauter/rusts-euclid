...
export class _ArcBase<U = any> extends SegmentWithFlatteningStep implements BoundingRect {
  ...
  public split_range(t_range: Range): _ArcBase<U> {
  ...
  public split(t: Scalar): [_ArcBase<U>, _ArcBase<U>] {
    let split_angle = Angle.radians(this.sweep_angle.get() * t)
    return [
      new _ArcBase(this.center, this.radii, this.start_angle, split_angle, this.x_rotation),
      new _ArcBase(
        this.center,
        this.radii,
  ...
  public before_split(t: Scalar): _ArcBase<U> {
    let split_angle = Angle.radians(this.sweep_angle.get() * t)
    return new _ArcBase(this.center, this.radii, this.start_angle, split_angle, this.x_rotation)
  }

  public after_split(t: Scalar): _ArcBase<U> {
    let split_angle = Angle.radians(this.sweep_angle.get() * t)
    return new _ArcBase(
      this.center,
      this.radii,
  ...
  public approx_length(tolerance: Scalar): Scalar {
    abstract_panic('Arc', 'approx_length')
    // Unreachable
...
export class Arc<U = any> extends ImplPartialEq(_ArcBase) implements Clone, Debug {
  public Self!: Arc<U>
  ...
  public split(t: Scalar): [this['Self'], this['Self']] {
    let [a1, a2] = super.split(t)
    return [
      new Arc(a1.center, a1.radii, a1.start_angle, a1.sweep_angle, a1.x_rotation),
      new Arc(a2.center, a2.radii, a2.start_angle, a2.sweep_angle, a2.x_rotation)
    ]
  }

  public before_split(t: Scalar): this['Self'] {
    let a = super.before_split(t)
    return new Arc(a.center, a.radii, a.start_angle, a.sweep_angle, a.x_rotation)
  }

  public after_split(t: Scalar): this['Self'] {
    let a = super.after_split(t)
    return new Arc(a.center, a.radii, a.start_angle, a.sweep_angle, a.x_rotation)
  }

  public split_range(t_range: Range): this['Self'] {
    let a = super.split_range(t_range)
    return new Arc(a.center, a.radii, a.start_angle, a.sweep_angle, a.x_rotation)
  }
